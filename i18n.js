...
window.XOi18n = (() => {
  const STRINGS = {
    en: {
      ...
      roomUnreachable: "Room not found or host unreachable. Check the code and try again.",
      langEn: "EN",
      langAr: "ع",
    },
    ar: {
      ...
      roomUnreachable: "الغرفة غير موجودة أو المضيف غير متاح. تحقق من الرمز وحاول مجدداً.",
      langEn: "EN",
      langAr: "ع",
    },
  };
